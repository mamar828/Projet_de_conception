...
while True:
    try:
        ...
        v_1 = input_0.read()            # Voltage between photoresistance and 1000 ohms resistance
        v_2 = 0                         # Ground

        # Check the validity of the voltage read
        if v_1 is not None:
            v_1 *= 5            # Convert 0-1 to 0-5 V
            ...
            # Give digital output between min_v_ratio and max_v_ratio
